package com.rr.springTest.spring.configurers;
...
import com.rr.springTest.auth.X509AuthFilter;

/**
 * Adds Custom X509 based pre authentication to an application. Since validating the
 *
 * @author Ross Romano
 */
public final class X509Configurer<H extends HttpSecurityBuilder<H>> extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, H>
{
    ...
    public X509Configurer<H> authenticationProvider(PreAuthenticatedAuthenticationProvider authenticationProvider)
    {
    ...
    private X509AuthenticationFilter getFilter(
        ...
        if (x509AuthenticationFilter == null) {
            ...
            x509AuthenticationFilter = new X509AuthFilter();
